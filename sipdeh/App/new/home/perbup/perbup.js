        ...
        <TouchableOpacity style={{
         ...
         <View style={s.IconContainer}>
          ...
          <View style={s.NumberContainer}>
            <Text style={{color:db.state.darkmode?"black":"white",
            fontWeight:'bold'}}>{panjang[i]}</Text>
          </View>
          <View style={s.TextContainer}>
            ...
            }}>Perda {value[0].charAt(0).toUpperCase() + value[0].substr(0, 5).slice(1) + ' ' + value[0].substr(5, 9)} </Text>
