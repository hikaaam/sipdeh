        ...
        if (Object.keys(data).length == 0) {
            return (
                <View style={{
                    ...
                    <Text style={{ fontSize: 40, color: '#222', marginTop: 20 }}> Server Error </Text>
                </View>
            )
        }
        else {
                    ...
                    >
                        <View style={{
                            ...
                            <View style={styles.IconContainer}>
                                <Icon2 name='user-tie' size={50} color={this.state.icon} />
                            </View>
                            <View style={s.NumberContainer} borderColor={rgb(73, 80, 87)} top={'25%'}>
